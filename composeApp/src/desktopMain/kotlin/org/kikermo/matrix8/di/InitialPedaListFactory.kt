...
val presets = listOf(
    ...
    Preset(
        id = "B",
        pedals = listOf(pedal1, pedal4).enanablePedals()
    ),
    Preset(
        id = "C",
        pedals = listOf(pedal3).enanablePedals()
    ),
    Preset(
        id = "D",
        pedals = listOf(pedal2, pedal3, pedal4).enanablePedals()
    )
)
